...
Though it may not seem intuitive, **setting formatting on a typewriter**, such as margin sizes and line spacing, is quite simple! Continue reading to learn how to format like a pro.
...
![Margin Stops](/assets/images/typewriter-margin-stops.png)
...
- Press the Carriage Centering Lever so that your carriage centers itself with the ruler on the typewriter.

     >Note: This is an important step. Having your carriage, and thus your paper, centered on the ruler will allow you to easily obtain equal left and right margin measurements.
...
- Next to the line spacing lever, you will notice some numbering. This numbering corresponds to the pre-set spacing options your machine will have. A number "1" will correspond to single spacing, "2" will correspond to double spacing, and "3" will correspond to triple spacing. Move the lever accordingly.

### Step 3: Test the spacing
